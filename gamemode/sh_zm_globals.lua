...
NPC_COND_SEE_ENEMY = 10
NPC_COND_CAN_RANGE_ATTACK1 = 21
NPC_COND_ENEMY_TOO_FAR = 27
NPC_COND_TOO_CLOSE_TO_ATTACK = 38
NPC_COND_FLOATING_OFF_GROUND = 61
NPC_COND_MOBBED_BY_ENEMIES = 62

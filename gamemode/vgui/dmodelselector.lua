...
local function ModelSelectionOpen()
	...
	PlayerModelSelectionFrame = window
	...
	local controls = window:Add("Panel")
	...
	local bdcontrols = window:Add("Panel")
...
local function ModelSelectionToggle()
	if IsValid(PlayerModelSelectionFrame) then PlayerModelSelectionFrame:Remove() end
	ModelSelectionOpen()
end
concommand.Add("playermodel_selector", ModelSelectionToggle)

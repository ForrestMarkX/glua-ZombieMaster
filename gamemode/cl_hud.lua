...
function MakepOptions()
    ...
    but:SetText(translate.Get("open_vol_menu"))
    but:Dock(TOP)
    ...
    binder:SetTall(24)
    binder:SetFont("OptionsHelpBig")
    binder:SetConVar("zm_killzombieskey")
    binder:SizeToContents()
    binder.UpdateText = BinderTextUpdate
    binder:Dock(TOP)
    binder:DockMargin(0, 8, 0, 4)
    ...
    slider:SetText(translate.Get("ragdoll_fade_speed"))
    ...
    slider:SetText(translate.Get("ragdoll_fade_time"))
    slider:SizeToContents()
    slider:Dock(TOP)
    slider:DockMargin(0, 8, 0, 4)
    catagorylist:AddItem(slider)
    ...
    qualitylab:SetText(translate.Get("zm_vision_quality"))
    ...
    qualitylab:Dock(TOP)
    qualitylab:SetFont("OptionsHelp")
    qualitylab:SetText(translate.Get("zm_spawntype_label"))
    qualitylab:SetTextColor(color_white)
    qualitylab:SizeToContents()
    catagorylist:AddItem(qualitylab)
    ...
    dropdown:Dock(TOP)
    dropdown:SetMouseInputEnabled(true)
    dropdown:AddChoice("Original")
    dropdown:AddChoice("Zombie Master : Reborn")
    dropdown.OnSelect = function(me, index, value, data)
        RunConsoleCommand("zm_cl_spawntype", value == "Zombie Master : Reborn" and 1 or 0)
    end
    ...
    qualitylab:Dock(TOP)
    qualitylab:SetFont("OptionsHelp")
    qualitylab:SetText(translate.Get("zm_humanhudtype_label"))
    qualitylab:SetTextColor(color_white)
    qualitylab:SizeToContents()
    catagorylist:AddItem(qualitylab)
    ...
    dropdown:AddChoice("Zombie Master : Reborn")
    dropdown.OnSelect = function(me, index, value, data)
        RunConsoleCommand("zm_hudtype", value == "Zombie Master : Reborn" and 1 or 0)
    end
    dropdown:SetText(qualitynum == 1 and "Zombie Master : Reborn" or "Original")
    catagorylist:AddItem(dropdown)
    ...
    slider:SetText(translate.Get("health_circle_brightness"))
    slider:SizeToContents()
    slider:Dock(TOP)
    slider:DockMargin(0, 8, 0, 4)
    catagorylist:AddItem(slider)
    ...
    slider:SetDecimals(2)
    slider:SetMinMax(0, 1)
    slider:SetConVar("zm_cl_silhouette_strength")
    slider:SetText(translate.Get("zm_silhouette_strength"))
    slider:SizeToContents()
    slider:Dock(TOP)
    slider:DockMargin(0, 8, 0, 4)
    catagorylist:AddItem(slider)
    ...
    slider:SetText(translate.Get("zm_scrollspeed"))
    slider:SizeToContents()
    slider:Dock(TOP)
    slider:DockMargin(0, 8, 0, 4)
    catagorylist:AddItem(slider)
    ...
    colorlab:SetText(translate.Get("zm_color_label"))
    ...
    colormix:SetWangs(true)
    colormix:SetConVarR("zm_itemhalo_r")
    ...
    colorlab:Dock(TOP)
    colorlab:SetFont("OptionsHelp")
    colorlab:SetText(translate.Get("zm_silhouette_label"))
    colorlab:SetTextColor(color_white)
    colorlab:SizeToContents()
    catagorylist:AddItem(colorlab)
    ...
    colormix:SetPalette(true)
    colormix:SetWangs(true)
    colormix:SetConVarR("zm_silhouette_r")
    colormix:SetConVarG("zm_silhouette_g")
    colormix:SetConVarB("zm_silhouette_b")
    catagorylist:AddItem(colormix)
